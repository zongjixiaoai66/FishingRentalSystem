<template>
  <div>
    ...
    <div style="margin: 10px 0" v-if="user.role == 'ROLE_ADMIN'">
      ...
      <!-- <el-upload action="http://localhost:9999/notice/import" :show-file-list="false" accept="xlsx" :on-success="handleExcelImportSuccess" style="display: inline-block">
...
<!--      <el-table-column prop="user" label="发布人"></el-table-column>-->
      ...
      <el-table-column label="操作"  width="300" align="center" v-if="user.role == 'ROLE_ADMIN'">
    ...
    handleAdd() {
      ...
      this.$nextTick(() => {
        if(!editor) {
          ...
          editor.config.uploadImgServer = 'http://localhost:9999/file/uploadImg'
...
// }
    ...
    exp() {
      window.open("http://localhost:9999/notice/export")
    },
